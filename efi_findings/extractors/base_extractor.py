...
from ..types import Finding, DocumentFindings, ExtractionConfig
...
class BaseFindingExtractor(ABC):
    ...
    def extract_findings(self, url: str, **kwargs) -> Optional[DocumentFindings]:
        """
    ...
    def _load_from_cache(self, cache_path: Path) -> Optional[DocumentFindings]:
        ...
        try:
            ...
            # Convert back to DocumentFindings
    ...
    def _save_to_cache(self, cache_path: Path, findings: DocumentFindings):
    ...
    def _findings_to_dict(self, doc_findings: DocumentFindings) -> Dict[str, Any]:
        """Convert DocumentFindings to dictionary for caching"""
