"""
Concrete LlamaRescorer using an OpenAI-compatible local server (e.g., Ollama).
"""
...
class LlamaReScorer(LLMReScorer):
    """LLM re-scorer using a local LLaMA model via OpenAI-compatible API.
    ...
    def __init__(self, config: LLMReScorerConfig | None = None, base_url: str | None = None, api_key: str | None = None):
        ...
        try:
            ...
            raise RuntimeError("openai package is required for LlamaReScorer") from exc
