...
class FindingsExtractor:
    ...
    def extract_findings(self, text: str, url: str, metadata: Optional[Dict[str, Any]] = None) -> DocumentFindings:
        """
        ...
        try:
            ...
            # Create DocumentFindings object
            doc_findings = DocumentFindings(
                url=url,
